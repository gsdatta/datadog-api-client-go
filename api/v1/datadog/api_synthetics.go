...
/*
 * GetBatch Get details of batch
 * Get a batch's updated details.
 */
func (a *SyntheticsApiService) GetBatch(ctx _context.Context, batchId string) (SyntheticsBatchDetails, *_nethttp.Response, error) {
	req := apiGetBatchRequest{
		ApiService: a,
		ctx:        ctx,
		batchId:    batchId,
	}

	return req.ApiService.getBatchExecute(req)
}
 ...
 */
func (a *SyntheticsApiService) getBatchExecute(r apiGetBatchRequest) (SyntheticsBatchDetails, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SyntheticsApiService.GetBatch")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
	...
	// Set Operation-ID header for telemetry
	localVarHeaderParams["DD-OPERATION-ID"] = "GetBatch"
